...
class Aqc(object):
    ...
    def run(self, target):
        ...
        basicData['isCollected'] = str(basicData['isCollected'])

        for index, value in enumerate(shareholdersData):
            try:
                shareholdersData[index]['isShowDetail'] = str(value['isShowDetail'])
            except:
                pass
            try:
                shareholdersData[index]['isShowChange'] = str(value['isShowChange'])
            except:
                pass
